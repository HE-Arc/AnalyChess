...
set :application, "AnalyChess"
set :repo_url, "git@github.com:HE-Arc/AnalyChess.git"
...
namespace :python do
    ...
    task :create_venv do
        ...
        execute "cat ~/www/AnalyChess/current/analychess/analychess/settings.py"
        execte "cd /www/AnalyChess/current/analychess_front"
        execute "npm install"
